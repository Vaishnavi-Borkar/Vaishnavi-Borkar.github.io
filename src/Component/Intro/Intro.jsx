    ...
    <div className="intro" id="home">
      <div className="intro-left">
        <div className="i-name">
          ...
          <span>
            <a href="https://github.com/Vaishnavi-Borkar">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6DNfRoZpiwEK_kRMszR86CIuP_1ILHJCtQGjPk28ccm6r2_6prEa0V7tzQEic5Ygfwhg&usqp=CAU" />
            </a>
            <a href="https://www.linkedin.com/in/vaishnavi-borkar21/">
              <img src="https://iconsplace.com/wp-content/uploads/_icons/ffa500/256/png/linkedin-icon-11-256.png" />
            </a>
          </span>
          <span>
